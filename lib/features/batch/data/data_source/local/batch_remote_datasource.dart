...
import 'package:student_management_starter/features/batch/data/dto/get_all_batches_dto.dart';
  ...
  Future<Either<Failure, List<BatchEntity>>> getAllBatches() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // OR
        // 2nd way
        GetAllBatchesDto batchAddDTO = GetAllBatchesDto.fromJson(response.data);
